...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'B:\PROGRAMMING\python\ADVANCED Python\pythonProject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'B:\PROGRAMMING\python\ADVANCED Python\pythonProject\venv\Scripts\deactivate.nu'
